...
def connect(aggdata1, aggdata2, dimension, left_inp = False, right_attrs = [],average=True, how = 'left'):
    print("aggdata1 dimensions: {}".format(aggdata1.agg_dimensions))
    print("aggdata2 dimensions: {}".format(aggdata2.agg_dimensions))
    ...
    print("left_attributes: {}".format(left_attributes))
    print("left name: {}".format(left_tablename))
    print("right_attributes: {}".format(right_attributes))
    print("right name: {}".format(right_tablename))
...
def select_features(train, test, seller, dimension, k, target, pca=False):
    print("Constructing join_test")
    print("test dimensions: {}".format(test.agg_dimensions))
    print("seller dimensions: {}".format(seller.agg_dimensions))
    join_test = connect(test, seller, dimension)
    print("Constructing join_train")
    print("train dimensions: {}".format(train.agg_dimensions))
    print("seller dimensions: {}".format(seller.agg_dimensions))
    join_train = connect(train, seller, dimension)
    
    #print("train.X: {}".format(train.X))
    #print("seller.X: {}".format(seller.X))
